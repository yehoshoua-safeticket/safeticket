        ...
        {loading ? (
          ...
          <table className="hidden w-full lg:table">
            ...
            <tbody className="divide-y divide-[var(--card-border)]">
              {filtered.map((d) => (
                <tr key={d.id} onClick={() => router.push(`/staff/disputes/${d.id}`)} className="cursor-pointer transition-colors hover:bg-[var(--input-bg)]">
          ...
          <ul className="divide-y divide-[var(--card-border)] lg:hidden">
            {filtered.map((d) => (
              <li
                key={d.id}
                onClick={() => router.push(`/staff/disputes/${d.id}`)}
