        ...
        {loading ? (
          ...
          <table className="hidden w-full lg:table">
            ...
            <tbody className="divide-y divide-[var(--card-border)]">
              {filtered.map((r) => (
                <tr key={r.id} onClick={() => router.push(`/staff/verifications/${r.id}`)} className="cursor-pointer transition-colors hover:bg-[var(--input-bg)]">
          ...
          <ul className="divide-y divide-[var(--card-border)] lg:hidden">
            {filtered.map((r) => (
              <li
                key={r.id}
                onClick={() => router.push(`/staff/verifications/${r.id}`)}
