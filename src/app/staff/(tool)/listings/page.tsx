  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          onClick={() => router.push('/staff/listings/new')}
        ...
        {loading ? (
          ...
          <table className="hidden w-full lg:table">
            ...
            <tbody className="divide-y divide-[var(--card-border)]">
              {filtered.map((l) => (
                <tr key={l.id} onClick={() => router.push(`/staff/listings/${l.id}`)} className="cursor-pointer transition-colors hover:bg-[var(--input-bg)]">
          ...
          <ul className="divide-y divide-[var(--card-border)] lg:hidden">
            {filtered.map((l) => (
              <li
                key={l.id}
                onClick={() => router.push(`/staff/listings/${l.id}`)}
